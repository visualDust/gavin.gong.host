...
![image](./imgs/index/0a808afeeb997181c4aac4071.png)
...
![image](./imgs/index/0a808afeeb997181c4aac4027.png)
...
通过表格理解术语：
![image](./imgs/index/0a808afeeb997181c4aac402c.png)
...
![image](./imgs/index/0a808afeeb997181c4aac402a.png)
...
E-R 图：
![image](./imgs/index/0a808afeeb997181c4aac4077.png)
...
Example:
![image](./imgs/index/0a808afeeb997181c4aac4030.png)
...
![image](./imgs/index/0a808afeeb997181c4aac405c.png)
...
:::
关系代数的运算符：
![image](./imgs/index/0a808afeeb997181c4aac4031.png)
...
![image](./imgs/index/0a808afeeb997181c4aac4053.png)
...
:::
![image](./imgs/index/0a808afeeb997181c4aac4057.png)
...
![image](./imgs/index/0a808afeeb997181c4aac4037.png)
...
![image](./imgs/index/0a808afeeb997181c4aac403b.png)
...
Example:
![image](./imgs/index/0a808afeeb997181c4aac4041.png)
...
Example：
![image](./imgs/index/0a808afeeb997181c4aac404a.png)
Another example：
...
Example：
![image](./imgs/index/0a808afeeb997181c4aac404d.png)
...
Another example:
![image](./imgs/index/0a808afeeb997181c4aac4069.png)
Another example:
![image](./imgs/index/0a808afeeb997181c4aac406a.png)
![image](./imgs/index/0a808afeeb997181c4aac406b.png)
除运算的现实意义：
![image](./imgs/index/0a808afeeb997181c4aac4058.png)
...
![image](./imgs/index/661857945e83d8bebb6755115.png)
...
右外连接：
![image](./imgs/index/41b22ce4147a6b085249dce04.png)
...
![image](./imgs/index/41b22ce4147a6b085249dce08.png)
...
转换关系：
![image](./imgs/index/41b22ce4147a6b085249dce0b.png)
...
![image](./imgs/index/41b22ce4147a6b085249dce0d.png)
...
![image](./imgs/index/41b22ce4147a6b085249dce34.png)
...
![image](./imgs/index/41b22ce4147a6b085249dce36.png)

使用 `ALTER TABLE` 可以修改表中的完整性约束：

![image](./imgs/index/41b22ce4147a6b085249dce37.png)
...
![image](./imgs/index/41b22ce4147a6b085249dce18.png)
...
![image](./imgs/index/41b22ce4147a6b085249dce4b.png)
...
![image](./imgs/index/41b22ce4147a6b085249dce50.jpg)
![image](./imgs/index/41b22ce4147a6b085249dce51.jpg)
![image](./imgs/index/41b22ce4147a6b085249dce52.jpg)
...
![image](./imgs/index/41b22ce4147a6b085249dce60.png)
![image](./imgs/index/41b22ce4147a6b085249dce61.png)
![image](./imgs/index/41b22ce4147a6b085249dce62.png)
...
Another Example：
![image](./imgs/index/41b22ce4147a6b085249dce63.png)
...
- 给定关系模式 $R(U_1,F_1)$ 和 $S(U_2,F_2)$，若 $X\subseteq U_1, X\subseteq U_2$，且 $X\nrightarrow U_1, X\mathop{\rightarrow}^{\mathop{F}} U_2$，则称 $X$ 是 $R$ 的外部码（Foreign Key），简称外码。主码与外码一起建立了关系间的联系表示。![image](./imgs/index/41b22ce4147a6b085249dce4c.png)
...
Example:
![image](./imgs/index/41b22ce4147a6b085249dce5a.png)
码是 $(S,J)$、$(J,P)$
...
![image](./imgs/index/41b22ce4147a6b085249dce4d.png)
...
![image](./imgs/index/41b22ce4147a6b085249dce4f.png)

![image](./imgs/index/41b22ce4147a6b085249dce4e.png)

第一范式存在问题：冗余度大、会引起修改操作的不一致性、数据插入异常、数据删除异常。

:::info
将一个 1NF 关系分解为多个 2NF 关系可以解决这些问题。
![image](./imgs/index/41b22ce4147a6b085249dce5d.png)
左图: 分解前; 右图: 分解后.
:::
...
第二范式，强调记录的唯一性约束，数据表必须有一个主键，并且没有包含在主键中的列必须完全依赖于主键，而不能只依赖于主键的一部分。例如：![image](./imgs/index/41b22ce4147a6b085249dce5e.png)
...
Another Example：
![image](./imgs/index/41b22ce4147a6b085249dce53.png)
...
![image](./imgs/index/41b22ce4147a6b085249dce5f.png)
上图中订单表中需要有客户相关信息，在分离出客户表之后，订单表中只需要有一个用户 id 即可（外键），而不能有其他的客户信息。因为其他的客户信息直接关联于用户 id，而不是直接与订单 id 直接关。

Another Example:
![image](./imgs/index/41b22ce4147a6b085249dce56.png)
![image](./imgs/index/41b22ce4147a6b085249dce57.png)
...
Example:
![image](./imgs/index/41b22ce4147a6b085249dce5b.png)

![image](./imgs/index/41b22ce4147a6b085249dce95.png)
...
Example：
![image](./imgs/index/41b22ce4147a6b085249dce65.png)
![image](./imgs/index/41b22ce4147a6b085249dce66.png)
![image](./imgs/index/41b22ce4147a6b085249dce64.png)
...
![image](./imgs/index/41b22ce4147a6b085249dce67.png)
...
![image](./imgs/index/41b22ce4147a6b085249dce68.png)
...
![image](./imgs/index/41b22ce4147a6b085249dce69.png)
Example:
![image](./imgs/index/41b22ce4147a6b085249dce6a.png)
...
Example：
![image](./imgs/index/41b22ce4147a6b085249dce6c.png)
...
![image](./imgs/index/41b22ce4147a6b085249dce6d.png)

Example：
![image](./imgs/index/41b22ce4147a6b085249dce6e.png)

![image](./imgs/index/41b22ce4147a6b085249dce6f.png)
...
![image](./imgs/index/41b22ce4147a6b085249dce70.png)

##### 保持函数依赖分解为 3NF 的算法

![image](./imgs/index/41b22ce4147a6b085249dce71.png)

Example:
![image](./imgs/index/41b22ce4147a6b085249dce72.png)

##### 既保持依赖又无损连接的分解方法

![image](./imgs/index/41b22ce4147a6b085249dce73.png)

Example:
![image](./imgs/index/41b22ce4147a6b085249dce74.png)

#### 消除传递依赖

![image](./imgs/index/41b22ce4147a6b085249dce54.png)
![image](./imgs/index/41b22ce4147a6b085249dce55.png)

Example:
![image](./imgs/index/41b22ce4147a6b085249dce58.png)
...
![image](./imgs/index/41b22ce4147a6b085249dce59.png)
...
| 类别 |                   描述                   |                                 图例                                 |
| :--: | :--------------------------------------: | :------------------------------------------------------------------: |
| 分类 | 将某一概念定义为现实世界中一组对象的类型 | ![image](./imgs/index/41b22ce4147a6b085249dce75.png) |
| 聚集 |          定义某一类型的组成成分          | ![image](./imgs/index/41b22ce4147a6b085249dce76.png) |
| 概括 |        定义类型之间的一种子集联系        | ![image](./imgs/index/41b22ce4147a6b085249dce77.png) |
...
例如：
![image](./imgs/index/41b22ce4147a6b085249dce78.png)
![image](./imgs/index/41b22ce4147a6b085249dce79.png)
...
![image](./imgs/index/41b22ce4147a6b085249dce82.png)

Example：
![image](./imgs/index/41b22ce4147a6b085249dce83.png)
...
![image](./imgs/index/41b22ce4147a6b085249dce96.png)

:::

![image](./imgs/index/41b22ce4147a6b085249dce97.png)
...
![image](./imgs/index/41b22ce4147a6b085249dce98.png)

![image](./imgs/index/41b22ce4147a6b085249dce99.png)
...
![image](./imgs/index/41b22ce4147a6b085249dce9a.png)
...
Example：
![image](./imgs/index/41b22ce4147a6b085249dce9b.png)
...
并发执行会导致可能的数据不一致性：
![image](./imgs/index/41b22ce4147a6b085249dceab.png)
...
锁的相容性：
![image](./imgs/index/41b22ce4147a6b085249dceac.png)
...
Examples：
![image](./imgs/index/41b22ce4147a6b085249dcead.png)
![image](./imgs/index/41b22ce4147a6b085249dceae.png)
![image](./imgs/index/41b22ce4147a6b085249dceaf.png)
![image](./imgs/index/41b22ce4147a6b085249dceb0.png)
...
![image](./imgs/index/41b22ce4147a6b085249dceb4.png)

如果并发控制不事先将所有需要的锁申请好，而是释放锁后，还允许再次申请锁，可能出现事务内两次操作同一对象之间，其它事务修改这一对象，从而导致不一致。

![image](./imgs/index/41b22ce4147a6b085249dceb5.png)
...
![image](./imgs/index/41b22ce4147a6b085249dceb6.png)

![image](./imgs/index/41b22ce4147a6b085249dceb7.png)

### 这一章怎么考

![image](./imgs/index/41b22ce4147a6b085249dceb3.png)
...
![image](./imgs/index/41b22ce4147a6b085249dce0f.png)
...
![image](./imgs/index/41b22ce4147a6b085249dce2a.png)
...
|:---:|:---:|
|![image](./imgs/index/41b22ce4147a6b085249dce3d.png)|![image](./imgs/index/41b22ce4147a6b085249dce3e.png)|

玄幻起来了，正常人（除了写前端的）一定会觉得第二个也应该是 true 的。

### 使用 EXISTS 减少不必要的检索

![image](./imgs/index/41b22ce4147a6b085249dce28.png)
...
![image](./imgs/index/41b22ce4147a6b085249dce3f.png)
...
![image](./imgs/index/41b22ce4147a6b085249dce41.png)

```sql
SELECT * FROM test WHERE timestamp_created like '2001-%';
```

![image](./imgs/index/41b22ce4147a6b085249dce42.png)
