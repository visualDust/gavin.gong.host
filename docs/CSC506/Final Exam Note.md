...
> [!NOTE]
> Instructor said: The exam will be closed-book and closed-notes, and no electronic devices are allowed. The material for the quiz comes from lectures and material covered in the text. In particular, all sections of the text listed in the Reading Assignments on Moodle will be the source of content for the exam.
...
> [!NOTE]
> Compare-and-Swap (CAS) using LL/SC
...
> [!NOTE]
> Using `<<<...>>>` to specify threads and their organization
>
...
> [!NOTE]
> Using `__shared__` to allocate shared memory
>
