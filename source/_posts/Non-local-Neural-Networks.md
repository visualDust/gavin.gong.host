...
![image-20210712175504851](/img/posts/Non-local-Neural-Networks/image-20210712175504851.png)
...
这篇论文的主要思想其实是（空间位置）自注意力机制的泛化表达。不过这篇论文只强调了空间注意力，并没有明显使用像{% post_link Squeeze-and-Excitation-Networks SENet %}那样的通道注意力。
